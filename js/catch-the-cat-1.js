    ...
    var k = function(t) {
        ...
        e.prototype.playerClick = function(t, e) {
			if(ff == 0){				
				...
				return n ? n.isWall ? (this.setStatusText(f.default("墙点击位置已经是墙了，禁止点击")),
				!1) : this.cat.i === t && this.cat.j === e ? (this.setStatusText(f.default("墙点击位置是猫当前位置，禁止点击")),
				!1) : (n.isWall = !0,
				this.cat.isCaught() ? (this.setStatusText(f.default("猫已经无路可走，你赢了")),
				this.state = i.WIN,
				!1) : (this.setStatusText(f.default("您（墙）点击了 ") + "(" + t + ", " + e + ")"),
				...
				this.state !== i.PLAYING)
					...
					!1;
				var n = this.getBlock(t, e);
				return n ? (n.isWall) ? (this.setStatusText(f.default("猫点击位置已经是墙了，禁止点击")),
				!1) : this.cat.i === t && this.cat.j === e ? (this.setStatusText(f.default("猫点击位置是猫当前位置，禁止点击")),
				!1) : ( !this.cat.makecatinneighbour(t,e))? 
				(this.setStatusText(f.default("猫点击位置不在猫附近，禁止点击")),
				!1)						
				:((this.setStatusText(f.default("您（猫）点击了 ") + "(" + t + ", " + e + ")"),
				this.cat.mystep(t,e) ,ff=0,
				!0)) : (this.setStatusText(f.default("代码错误，当前位置不存在")),
				!1)
/*				return n ? (n.isWall) ? (this.setStatusText(f.default("猫点击位置已经是墙了，禁止点击")),
				!1) : this.cat.i === t && this.cat.j === e ? (this.setStatusText(f.default("猫点击位置是猫当前位置，禁止点击")),
...
, function(t, e, n) {
    ...
    var i = n(0)
      ...
      , l = function(t) {
		...
		,
		e.prototype.mystep = function(e,n) {
			
            //this.setIJ(e,n)
			for(var xx=0;xx<6;xx++){
				var t = this.getCurrentNeighbours()[xx];
				if(e===t.i&&n===t.j) this.stepDirection(xx);
			}
        }
		,
		e.prototype.makecatinneighbour = function(e,n) {
			var flg = 0;
			for(var xx=0;xx<6;xx++){
				var t = this.getCurrentNeighbours()[xx];
				flg = flg || (e===t.i&&n===t.j);
